...
public class ErrollUserCardAddDelete {
    ...
    @Test
    public void errollUserCardAddDelete() throws InterruptedException {
        ...
        ViewInteraction cardEditText = onView(
                allOf(withId(com.braintreepayments.cardform.R.id.bt_card_form_card_number),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        cardEditText.perform(replaceText("5523301001943694"), closeSoftKeyboard());
        ...
        ViewInteraction expirationDateEditText = onView(
                allOf(withId(com.braintreepayments.cardform.R.id.bt_card_form_expiration),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        expirationDateEditText.perform(replaceText("0329"), closeSoftKeyboard());
        ...
        ViewInteraction cvvEditText = onView(
                allOf(withId(com.braintreepayments.cardform.R.id.bt_card_form_cvv),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        cvvEditText.perform(replaceText("546"), closeSoftKeyboard());
