...
public class UserAddFamilyProcess {
    ...
    @Test
    public void userAddFamilyProcess() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.fam_first),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Janet"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.fam_mon),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("12000"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.fam_ann),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("70000"), closeSoftKeyboard());
